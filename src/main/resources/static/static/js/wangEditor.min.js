!function (e, t) {
    ...
    function u(e) {
        var t = this;
        this.editor = e, this.$elem = o('<div class="w-e-menu z-index-19"><i class="w-e-icon-header"></i></div>'), this.type = "droplist", this._active = !1, this.droplist = new d(this, {
            width: 100,
            $title: o("<p>设置标题</p>"),
            type: "list",
    ...
    function h(e) {
        var t = this;
        this.editor = e, this.$elem = o('<div class="w-e-menu z-index-19"><i class="w-e-icon-text-heigh"></i></div>'), this.type = "droplist", this._active = !1, this.droplist = new d(this, {
            width: 160,
            $title: o("<p>字号</p>"),
            type: "list",
            list: [{
    ...
    function p(e) {
        var t = this;
        this.editor = e, this.$elem = o('<div class="w-e-menu z-index-19"><i class="w-e-icon-font"></i></div>'), this.type = "droplist", this._active = !1;
    ...
    function B(e) {
        var t = this;
        this.editor = e, this.$elem = o('<div class="w-e-menu z-index-19"><i class="w-e-icon-list2"></i></div>'), this.type = "droplist", this._active = !1, this.droplist = new d(this, {
            width: 120,
            $title: o("<p>设置列表</p>"),
            type: "list",
            list: [{
    ...
    function y(e) {
        var t = this;
        this.editor = e, this.$elem = o('<div class="w-e-menu z-index-19"><i class="w-e-icon-paragraph-left"></i></div>'), this.type = "droplist", this._active = !1, this.droplist = new d(this, {
            width: 100,
            $title: o("<p>对齐方式</p>"),
            type: "list",
            list: [{
    ...
    function C(e) {
        var t = this;
        this.editor = e, this.$elem = o('<div class="w-e-menu z-index-19"><i class="w-e-icon-pencil2"></i></div>'), this.type = "droplist";
    ...
    function x(e) {
        var t = this;
        this.editor = e, this.$elem = o('<div class="w-e-menu z-index-19"><i class="w-e-icon-paint-brush"></i></div>'), this.type = "droplist";
        var n = e.config, i = n.colors || [];
        this._active = !1, this.droplist = new d(this, {
            width: 120,
            $title: o("<p>背景色</p>"),
    ...
    j.prototype = {
        constructor: j, _initConfig: function () {
            ...
            null == i ? (a = o("<div></div>"), s = o("<div></div>"), d = n.children(), n.append(a).append(s), a.css("background-color", "#ffffff").css("border", "1px solid #ececec"), s.css("border", "1px solid #ececec").css("border-top", "none").css("height", "360px")) : (a = n, s = o(i), d = s.children()), l = o("<div></div>"), l.attr("contenteditable", "true").css("width", "100%").css("height", "100%"), d && d.length ? l.append(d) : l.append(o("<p><br></p>")), s.append(l), a.addClass("w-e-toolbar"), s.addClass("w-e-text-container"), l.addClass("w-e-text");
